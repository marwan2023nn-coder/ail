...
describe('main/app/intercom', () => {
    describe('handleWelcomeScreenModal', () => {
        ...
        it('should show welcomeScreen modal', async () => {
            ...
            handleWelcomeScreenModal();
            expect(ModalManager.addModal).toHaveBeenCalledWith('welcomeScreen', 'workspace-desktop://renderer/welcomeScreen.html', '/some/preload.js', {prefillURL: undefined}, {}, true);
        });
    });
