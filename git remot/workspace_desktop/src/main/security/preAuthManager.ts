...
const loginModalHtml = 'workspace-desktop://renderer/loginModal.html';
const preAuthModalHtml = 'workspace-desktop://renderer/preAuthHeaderModal.html';
const html = 'workspace-desktop://renderer/certificateModal.html';
