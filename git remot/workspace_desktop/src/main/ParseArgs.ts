...
function triageArgs(args: string[]) {
    ...
    if (electronBuilder.protocols && electronBuilder.protocols[0] && electronBuilder.protocols[0].schemes && electronBuilder.protocols[0].schemes[0]) {
        const scheme = electronBuilder.protocols[0].schemes[0].toLowerCase();
