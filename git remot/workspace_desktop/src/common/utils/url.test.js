    ...
    describe('isCallsPopOutURL', () => {
        it('should match correct URL', () => {
            expect(isCallsPopOutURL(
                ...
                new URL('http://example.org/team/com.workspace.calls/expanded/callid'),
                'callid',
            )).toBe(true);
        });
        ...
        it('should match with subpath', () => {
            expect(isCallsPopOutURL(
                ...
                new URL('http://example.org/subpath/team/com.workspace.calls/expanded/callid'),
                'callid',
            )).toBe(true);
        });
        ...
        it('should match with teamname with dash', () => {
            expect(isCallsPopOutURL(
                new URL('http://example.org'),
                new URL('http://example.org/team-name/com.workspace.calls/expanded/callid'),
                'callid',
            )).toBe(true);
        });
        ...
        it('should not match with invalid team name', () => {
            expect(isCallsPopOutURL(
                new URL('http://example.org'),
                new URL('http://example.org/invalid$team/com.workspace.calls/expanded/othercallid'),
                'callid',
            )).toBe(false);
        });
        ...
        it('should not match with incorrect callid', () => {
            expect(isCallsPopOutURL(
                new URL('http://example.org'),
                new URL('http://example.org/team/com.workspace.calls/expanded/othercallid'),
                'callid',
            )).toBe(false);
        });
        ...
        it('should match with regex path embedded', () => {
            expect(isCallsPopOutURL(
                ...
                new URL('http://example.org//path\\(a\\+\\)\\+/team/com.workspace.calls/expanded/callid'),
                'callid',
            )).toBe(false);
        });
    });
