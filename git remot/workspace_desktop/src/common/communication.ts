...
export const GET_EXTENSIONS = 'get-extensions';
...
export const CALLS_SEND_REMOTE_CONTROL_EVENT = 'calls-send-remote-control-event';
export const CALLS_REMOTE_CONTROL_REQUEST_PERMISSION = 'calls-remote-control-request-permission';
export const CALLS_REMOTE_CONTROL_TERMINATE_SESSION = 'calls-remote-control-terminate-session';
