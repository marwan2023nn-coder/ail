...
#### Linux Dependencies for Remote Control
To enable Remote Control functionality on Linux (Ubuntu/Debian), ensure you have the following packages installed:
```bash
...
* `./workspace-desktop --args --data-dir ~/my-mattermost-data/` on Linux
